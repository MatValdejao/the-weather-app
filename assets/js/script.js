		...
		if (i === 0) {
			...
			if (parseInt(dataList[i]) <= 2) {
				itemListEl.innerHTML =
					"UV Index:<button class='btn green'>" + uvi + "</button>";
			} else if (parseInt(dataList[i]) <= 5) {
				itemListEl.innerHTML =
					"UV Index:<button class='btn yellow'>" + uvi + "</button>";
			} else if (parseInt(dataList[i]) <= 7) {
				itemListEl.innerHTML =
					"UV Index:<button class='btn orange'>" + uvi + "</button>";
			} else if (7.0 < parseInt(dataList[i])) {
				itemListEl.innerHTML =
					"UV Index:<button class='btn red'>" + uvi + "</button>";
			}
		}
